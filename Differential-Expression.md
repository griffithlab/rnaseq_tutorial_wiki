...
---
###OPTIONAL ALTERNATIVE - Merge Cufflinks GTFs for HISAT2
Perform the merge step for HISAT2-alignment-based cufflinks output:

	cd $RNA_HOME/expression/hisat2_cufflinks/ref_only/
	ls -1 *Rep*ERCC*/transcripts.gtf > assembly_GTF_list.txt
	cuffmerge -p 8 -o merged -g $RNA_HOME/refs/hg19/genes/genes_chr22_ERCC92.gtf -s $RNA_HOME/refs/hg19/fasta/chr22_ERCC92/ assembly_GTF_list.txt

####END OF OPTIONAL ALTERNATIVE - Merge Cufflinks GTFs for HISAT2
---
...
---
###OPTIONAL ALTERNATIVE - CuffDiff for HISAT2 results
perform the cuffdiff step for HISAT2-alignment-based cuffmerge output:
...
####END OF OPTIONAL ALTERNATIVE - CuffDiff for HISAT2 results
---
