######ALIGNMENT
######6.) Use Bowtie2/Tophat2 to align all pairs of read files to the genome.  The output of this step will be a SAM/BAM files for each data set.
...
######OPTIONAL
######6b.) perform alignments with STAR
